...
Recomienda vinos, procesa las ordenes y genera cotizaciones con integracion a WhatsApp.
...
| `INSTRUCCIONES_EQUIPO.md` | Guía de integración con Flet |
...
| Amazon RDS PostgreSQL | Catalogo de vinos |
| Amazon Polly (Mia Neural) | Texto a voz en español mexicano |

## Integracion con Flet
...
- El numero de WhatsApp se configura en `agente_vinos.py`